...
public class TnsOtaPreferences implements Constants {

    public static final String TAG = "TnsOtaPreferences";
    ...
    public static boolean isDeviceUpdating(Context context) {
        return getPrefs(context).getBoolean(DEVICE_UPDATING, false);
    }
    ...
    public static void setUpdateLastChecked(Context context, String time) {
        SharedPreferencesEditor editor = getPrefs(context).edit();
    ...
    public static void setDeviceUpdating(Context context, boolean value) {
        SharedPreferencesEditor editor = getPrefs(context).edit();
        editor.putBoolean(DEVICE_UPDATING, value);
        editor.apply();
    }
}