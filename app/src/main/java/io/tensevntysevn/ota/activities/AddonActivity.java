...
import io.tensevntysevn.ota.download.DownloadAddon;
import io.tensevntysevn.ota.tasks.AddonXmlParser;
import io.tensevntysevn.ota.utils.Addon;
...
public class AddonActivity extends Activity implements Constants {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        new LoadAddonManifest(mContext).execute(OtaManifestUtils.getAddonsUrl(mContext));
    }
    ...
    public static class AddonsArrayAdapter extends ArrayAdapter<Addon> {
        ...
        public View getView(int position, View convertView, @NonNull ViewGroup parent) {
            ...
            filesize.setText(TnsOtaUtils.formatDataFromBytes(item.getFilesize()));
            ...
            download.setOnClickListener(v -> {
                ...
                boolean isSettingWiFiOnly = TnsOtaPreferences.getNetworkType(mContext).equals
                        (WIFI_ONLY);
