...
public class DownloadRomProgress extends AsyncTask<Long, Integer, Void> implements Constants {
    ...
    protected Void doInBackground(Long... params) {
        int previousValue = 0;
        while (TnsOtaPreferences.getIsDownloadOnGoing(mContext)) {
            long mDownloadID = TnsOtaPreferences.getDownloadID(mContext);
            ...
            try {
                ...
                if (cursor.getInt(cursor.getColumnIndex(DownloadManager.COLUMN_STATUS)) ==
                    ...
                    TnsOtaPreferences.setIsDownloadRunning(mContext, false);
                }
